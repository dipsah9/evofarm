...
// CreateJob inserts a new job row when a job is submitted.
...
// ListJobs returns the most recent jobs (for the history endpoint).
func (d *DB) ListJobs(ctx context.Context, limit int) ([]JobRecord, error) {
